...
const AboutSection = () => {
  ...
  const skills = [
    ...
    { name: 'Natural Langauge Processing (NLP)', level: 80, color: '#00d9ff' },
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                <h3 className="text-3xl font-bold text-cyan-400 tracking-wide" style={{fontFamily: 'Orbitron, sans-serif', letterSpacing: '0.05em'}}>
                  WHO I AM
                </h3>
              ...
              <div className="grid grid-cols-2 gap-6 pt-8">
                <div className="text-center backdrop-blur-xl bg-white/5 border border-cyan-500/30 rounded-2xl p-4 hover:bg-white/10 transition-all duration-300">
                  <div className="text-4xl font-bold text-cyan-400 mb-1" style={{fontFamily: 'Orbitron, sans-serif'}}>1+</div>
                  <div className="text-xs text-gray-400 tracking-wider" style={{fontFamily: 'Rajdhani, sans-serif'}}>YEAR EXP</div>
                </div>
                <div className="text-center backdrop-blur-xl bg-white/5 border border-purple-500/30 rounded-2xl p-4 hover:bg-white/10 transition-all duration-300">
                  <div className="text-4xl font-bold text-purple-400 mb-1" style={{fontFamily: 'Orbitron, sans-serif'}}>10+</div>
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                <h3 className="text-3xl font-bold text-purple-400 tracking-wide" style={{fontFamily: 'Orbitron, sans-serif', letterSpacing: '0.05em'}}>
                  EXPERTISE
                </h3>
                <div className="h-1 w-16 bg-gradient-to-r from-purple-500 to-green-500 rounded-full" />
              </div>
                ...
                {skills.map((skill, index) => (
                  ...
                  >
                    <div className="flex justify-between mb-2">
                      <span className="text-gray-300 font-medium tracking-wider" style={{fontFamily: 'Rajdhani, sans-serif'}}>
                        {skill.name}
                      </span>
                      <span 
                    ...
                    <div className="h-3 bg-gray-800/50 rounded-full overflow-hidden backdrop-blur-sm border border-white/5">
                      <div 
              ...
              <div className="pt-6">
                <a 
                  ...
                  className="block w-full px-8 py-4 bg-gradient-to-r from-cyan-500 via-purple-500 to-green-500 rounded-full text-white font-semibold hover:shadow-lg hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105 tracking-widest text-center" 
